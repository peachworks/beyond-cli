...
class Query {
  constructor(config) {
    ...
    this.url = config.originalParams.url;
    this.method = config.originalParams.method.toLowerCase();
    this.json = config.originalParams.json;
    this.export = config.originalParams.export;
    this.find = config.originalParams.find;
    // this.findIncludes = config.originalParams.findIncludes;
    // this.includes = config.originalParams.includes;
    this.fields = config.originalParams.fields;
    this.sort = config.originalParams.sort;
    this.limit = config.originalParams.limit;
    this.page = config.originalParams.page;
