...
class RunnerProcess extends BaseProcess {
  ...
  constructor(config) {
    ...
    this.renderConfig = {
      BeyondApp     : {
        ...
        api               : {
          checkoutApiUrl    : this.config.checkoutApiUrl,
          checkoutClientUrl : this.config.checkoutClientUrl,
          hubURL            : this.config.hubUrl,
          payrollApiUrl     : this.config.payrollApiUrl,
  ...
  start() {
    ...
    this.app.get('/marketing/links', (req, res) => {
      res.send([]);
    });
